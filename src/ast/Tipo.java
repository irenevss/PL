...
public class Tipo_int extends Tipo {
    public Tipo_int() {}
...
public class Tipo_real extends Tipo {
    public Tipo_real() {}
...
public class Tipo_bool extends Tipo {
    public Tipo_bool() {}
...
public class Tipo_string extends Tipo {
    public Tipo_string() {}
...
public class Tipo_id extends Tipo {
    public String id;
    public int fila, col;
...
public class Tipo_pointer extends Tipo {
    public Tipo tipo;
...
public class Tipo_record extends Tipo {
