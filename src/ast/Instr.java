...
class Instr_asig extends Instr {
    public Exp exp1;
    public Exp exp2;
...
class Instr_ifelse extends Instr {
    public Exp exp;
...
class Instr_while extends Instr {
    public Exp exp;
    public LInstr_0 instrs;
...
class Instr_lectura extends Instr {
    public Exp exp;
...
class Instr_escritura extends Instr {
    public Exp exp;
...
class Instr_reserva extends Instr {
    public Exp exp;
...
class Instr_liberacion extends Instr {
    public Exp exp;
...
class Instr_compuesta extends Instr {
    public LDec_0 decs;
    public LInstr_0 instrs;
...
class Instr_invocar extends Instr {
    public String id;
    public LExps_0 exps;
    public int fila, col;
