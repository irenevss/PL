...
// Binary expressions
public class Exp_suma extends Exp {
    public Exp opnd0;
    public Exp opnd1;
    public int fila, col;
...
public class Exp_menor extends Exp {
    public Exp opnd0;
    public Exp opnd1;
    public int fila, col;
...
// Add other comparison ops similarly

public class Exp_mayor extends Exp {
    public Exp opnd0;
    public Exp opnd1;
    public int fila, col;
...
public class Exp_menor_igual extends Exp {
    public Exp opnd0;
    public Exp opnd1;
    public int fila, col;
...
public class Exp_mayor_igual extends Exp {
    public Exp opnd0;
    public Exp opnd1;
    public int fila, col;
...
public class Exp_igual extends Exp {
    public Exp opnd0;
    public Exp opnd1;
    public int fila, col;
...
public class Exp_distinto extends Exp {
    public Exp opnd0;
    public Exp opnd1;
    public int fila, col;
...
// Unary
public class Exp_menos_unario extends Exp {
    public Exp opnd;
    public int fila, col;
...
public class Exp_asterisco_unario extends Exp {
    public Exp opnd;
    public int fila, col;
...
public class Lit_int extends Exp {
    public String val;
    public int fila, col;
...
public class Lit_real extends Exp {
    public String val;
    public int fila, col;
...
public class Lit_bool extends Exp {
    public String val;
    public int fila, col;
...
public class Lit_string extends Exp {
    public String val;
    public int fila, col;
...
public class Op_campo extends PostfixOp {
    public String id;
    public int fila, col;
...
public class Op_flecha extends PostfixOp {
    public String id;
    public int fila, col;
...
public class Op_array extends PostfixOp {
    public Exp index;
    public int fila, col;
...
public class Exp_campo extends Exp {
    public Exp base;
    public String id;
    public int fila, col;
...
public class Exp_flecha extends Exp {
    public Exp base;
    public String id;
    public int fila, col;
...
public class Exp_array extends Exp {
    public Exp opnd0;
    public Exp opnd1;
    public int fila, col; // for [
