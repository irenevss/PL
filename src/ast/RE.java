...
// For factorized grammar
abstract class RE0 {
    public abstract Exp apply(Exp left);
}

class RE0_op extends RE0 {
    public String op;
    public Exp right;
