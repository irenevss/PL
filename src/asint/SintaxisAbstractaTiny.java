...
public class SintaxisAbstractaTiny {
    ...
    public static class Tipo_id extends Tipo {
        ...
        @Override
        public String imprime() { return id + "$f:" + leeFila() + ",c:" + leeCol() + "$"; }
    }
    ...
    public static class Tipo_pointer extends Tipo {
        ...
        @Override
        public String imprime() { return "<pointer>\n" + tipo.imprime(); }
    }
    ...
    public static class Un_camporecord extends ListaRecord {
        ...
        @Override
        public String imprime() { return campo.imprime(); }
    }
    ...
    public static class Si_procparam extends LProcParams_0 {
        ...
        @Override
        public String imprime() { return params.imprime() + "\n"; }
    }
    ...
    public static class Un_procparam extends LProcParams {
        ...
        @Override
        public String imprime() { return param.imprime(); }
    }
    ...
    public static class Param_ref extends Param {
        ...
        @Override
        public String imprime() { return "<ref>\n" + id + "$f:" + leeFila() + ",c:" + leeCol() + "$\n:\n" + tipo.imprime(); }
    }
    ...
    public static class Si_instr extends Instrs_0 {
        ...
        @Override
        public String imprime() { return instrs.imprime(); }
    }
    ...
    public static class Una_instr extends LInstr {
        ...
        @Override
        public String imprime() { return instr.imprime(); }
    }
    ...
    public static class Instr_asig extends Instr {
        ...
        @Override
        public String imprime() { return e1.imprime() + ":=\n" + e2.imprime(); }
    }
    ...
    public static class Instr_if extends Instr {
        ...
        @Override
        public String imprime() { return "<if>\n" + exp.imprime() + ":\n" + instrs.imprime() + "<end_if>"; }
    }
    ...
    public static class Instr_while extends Instr {
        ...
        @Override
        public String imprime() { return "<while>\n" + exp.imprime() + ":\n" + instrs.imprime() + "<end_while>"; }
    }
    ...
    public static class Instr_lectura extends Instr {
        ...
        @Override
        public String imprime() { return "<input>\n" + exp.imprime(); }
    }
    ...
    public static class Instr_escritura extends Instr {
        ...
        @Override
        public String imprime() { return "<output>\n" + exp.imprime(); }
    }
    ...
    public static class Instr_reserva extends Instr {
        ...
        @Override
        public String imprime() { return "<new>\n" + exp.imprime(); }
    }
    ...
    public static class Instr_liberacion extends Instr {
        ...
        @Override
        public String imprime() { return "<dispose>\n" + exp.imprime(); }
    }
    ...
    public static class Si_exps extends LExps_0 {
        ...
        @Override
        public String imprime() { return exps.imprime(); }
    }

    public static class No_exps extends LExps_0 {
        public String toString() { return "no_exps()"; }
        @Override
        public String imprime() { return ""; }
    }
    ...
    public static class Una_exp extends LExps {
        ...
        @Override
        public String imprime() { return exp.imprime(); }
    }
    ...
    public static abstract class Exp extends Nodo {
        ...
        protected String imprimeOpnd(Exp opnd, int minPrior, boolean isRight) {
            ...
            if (prior_opnd == minPrior && isRight && (prior_opnd == 1 || prior_opnd == 2 || prior_opnd == 3 || prior_opnd == 0 || prior_opnd == -1)) {
                needs_parens = true;
            }
            if (needs_parens) {
                return "(\n" + opnd.imprime() + ")\n";
    ...
    public static class Exp_array extends Exp {
        ...
        @Override public String imprime() { return imprimeOpnd(exp, 5, false) + "[\n$f:" + leeFila() + ",c:" + leeCol() + "$\n" + idx.imprime() + "]\n"; }
    }
    ...
    public static class Lit_int extends Exp {
        ...
        @Override public int prioridad() { return 6; }
        @Override public String imprime() { return num + "$f:" + leeFila() + ",c:" + leeCol() + "$\n"; }
    }
    ...
    public static class Lit_bool extends Exp {
        ...
        @Override public int prioridad() { return 6; }
        @Override public String imprime() { return valor + "$f:" + leeFila() + ",c:" + leeCol() + "$\n"; }
    }
    ...
    public Iden iden(String id) { return new Iden(id); }
    public Lit_int lit_int(String n) { return new Lit_int(n); }
    public Lit_real lit_real(String n) { return new Lit_real(n); }
    public Lit_bool lit_bool(String b) { return new Lit_bool(b); }
    public Lit_string lit_string(String s) { return new Lit_string(s); }
    public Lit_null lit_null() { return new Lit_null(); }
}