...
public class SintaxisAbstractaTiny {
    ...
    public static class Prog extends Nodo {
        ...
        public String imprime() {
            return "<program>\n" + decs.imprime() + instrs.imprime() + "<end_program>\n";
        }
    }
    ...
    public static class Dec_var extends Dec {
        ...
        public Dec_var(String id, Tipo tipo) {
            this.id = id;
            this.tipo = tipo;
        }

        public String toString() {
            return "dec_var(" + id + "[" + leeFila() + "," + leeCol() + "]," + tipo + ")";
        }
    ...
    public static class Dec_tipo extends Dec {
        ...
        public Dec_tipo(String id, Tipo tipo) {
            this.id = id;
            this.tipo = tipo;
        }
    ...
    public static class Tipo_id extends Tipo {
        ...
        public String toString() {
            return "tipo_id(" + id + "[" + leeFila() + "," + leeCol() + "])";
        }
    ...
    public static class Tipo_array extends Tipo {
        ...
        public Tipo_array(String tam, Tipo tipo) {
            this.tam = tam;
            this.tipo = tipo;
        }

        public String toString() {
            return "tipo_array(" + tam + "," + tipo + ")";
        }

        @Override
        public String imprime() { return "<array>\n[\n" + tam + "\n]$f:" + leeFila() + ",c:" + leeCol() + "$\n<of>\n" + tipo.imprime(); }
    }
    ...
    public static class Tipo_record extends Tipo {
        ...
        public Tipo_record(ListaRecord campos) {
            this.campos = campos;
        }

        public String toString() {
            return "tipo_record(" + campos + ")";
        }

        @Override
        public String imprime() { return "<record>\n" + campos.imprime() + "<end_record>\n"; }
    }
    ...
    public static class Muchos_camposrecord extends ListaRecord {
        ...
        public String toString() {
            return "muchos_camposrecord(" + lista + "," + campo + ")";
        }

        @Override
        public String imprime() { return lista.imprime() + ";\n" + campo.imprime(); }
    }
    ...
    public static class CamposRecord extends Nodo {
        ...
        public CamposRecord(String id, Tipo tipo) {
            this.id = id;
            this.tipo = tipo;
        }

        public String toString() {
            return "camporecord(" + id + "[" + leeFila() + "," + leeCol() + "]," + tipo + ")";
        }
    ...
    public static class Muchos_procparam extends LProcParams {
        ...
        public String toString() {
            return "muchos_procparam(" + lista + "," + param + ")";
        }
    ...
    public static class Param_ref extends Param {
        ...
        public Param_ref(String id, Tipo tipo) {
            this.id = id;
            this.tipo = tipo;
        }

        public String toString() {
            return "param_ref(" + id + "[" + leeFila() + "," + leeCol() + "]," + tipo + ")";
        }
    ...
    public static class Param_val extends Param {
        ...
        public Param_val(String id, Tipo tipo) {
            this.id = id;
            this.tipo = tipo;
        }

        public String toString() {
            return "param_val(" + id + "[" + leeFila() + "," + leeCol() + "]," + tipo + ")";
        }
    ...
    public static class Si_instr0 extends LInstr_0 {
        ...
        public Si_instr0(LInstr instrs) {
            this.instrs = instrs;
        }

        public String toString() {
            return "si_instr0(" + instrs + ")";
        }
    ...
    public static class Muchas_instr extends LInstr {
        ...
        public String toString() {
            return "muchas_instr(" + lista + "," + instr + ")";
        }
    ...
    public static class Instr_asig extends Instr {
        ...
        public Instr_asig(Exp e1, Exp e2) {
            this.e1 = e1;
            this.e2 = e2;
        }

        public String toString() {
            return "instr_asig(" + e1 + "," + e2 + ")";
        }
    ...
    public static class Instr_invocar extends Instr {
        ...
        public String toString() {
            return "instr_invocar(" + id + "[" + leeFila() + "," + leeCol() + "]," + params + ")";
        }
    ...
    public static class Instr_compuesta extends Instr {
        ...
        public String toString() {
            return "instr_compuesta(" + decs + "," + instrs + ")";
        }
    ...
    public static class Muchas_exps extends LExps {
        ...
        public Muchas_exps(LExps lista, Exp exp) {
            this.lista = lista;
            this.exp = exp;
        }

        public String toString() {
            return "muchas_exps(" + lista + "," + exp + ")";
        }
    ...
    public static class Exp_suma extends ExpBin {
        ...
        @Override
        public String imprime() {
            return imprimeOpnd(opnd0, 1, false) + "+$f:" + leeFila() + ",c:" + leeCol() + "$\n" + imprimeOpnd(opnd1, 1, true);
        }
    }

    public static class Exp_resta extends ExpBin {
        public Exp_resta(Exp o0, Exp o1) {
            super(o0, o1);
        }
    ...
    public static class Exp_mul extends ExpBin {
        ...
        @Override
        public String imprime() {
            return imprimeOpnd(opnd0, 3, false) + "*$f:" + leeFila() + ",c:" + leeCol() + "$\n" + imprimeOpnd(opnd1, 3, true);
        }
    }

    public static class Exp_div extends ExpBin {
        public Exp_div(Exp o0, Exp o1) {
            super(o0, o1);
        }
    ...
    public static class Exp_and extends ExpBin {
        ...
        @Override
        public String imprime() {
            return imprimeOpnd(opnd0, 4, false) + "&$f:" + leeFila() + ",c:" + leeCol() + "$\n" + imprimeOpnd(opnd1, 4, true);
        }
    }

    public static class Exp_or extends ExpBin {
        public Exp_or(Exp o0, Exp o1) {
            super(o0, o1);
        }
        ...
        @Override
        public String imprime() {
            return imprimeOpnd(opnd0, 2, false) + "|$f:" + leeFila() + ",c:" + leeCol() + "$\n" + imprimeOpnd(opnd1, 2, true);
        }
    }

    public static class Exp_menor extends ExpBin {
        public Exp_menor(Exp o0, Exp o1) {
            super(o0, o1);
        }
        ...
        @Override
        public String imprime() {
            return imprimeOpnd(opnd0, 0, false) + "<$f:" + leeFila() + ",c:" + leeCol() + "$\n" + imprimeOpnd(opnd1, 0, true);
        }
    }

    public static class Exp_mayor extends ExpBin {
        public Exp_mayor(Exp o0, Exp o1) {
            super(o0, o1);
        }
        ...
        public int prioridad() { return 0; }
        @Override
        public String imprime() { return imprimeOpnd(opnd0, 0, false) + ">$f:" + leeFila() + ",c:" + leeCol() + "$\n" + imprimeOpnd(opnd1, 0, true); }
    }

    public static class Exp_menor_igual extends ExpBin {
        public Exp_menor_igual(Exp o0, Exp o1) {
            super(o0, o1);
        }

        public String toString() {
            return "exp_menor_igual(" + opnd0 + "," + opnd1 + ")";
        }
    ...
    public static class Exp_mayor_igual extends ExpBin {
        public Exp_mayor_igual(Exp o0, Exp o1) {
            super(o0, o1);
        }

        public String toString() {
            return "exp_mayor_igual(" + opnd0 + "," + opnd1 + ")";
        }
    ...
    public static class Exp_igual extends ExpBin {
        public Exp_igual(Exp o0, Exp o1) {
            super(o0, o1);
        }

        public String toString() {
            return "exp_igual(" + opnd0 + "," + opnd1 + ")";
        }
    ...
    public static class Exp_distinto extends ExpBin {
        public Exp_distinto(Exp o0, Exp o1) {
            super(o0, o1);
        }

        public String toString() {
            return "exp_distinto(" + opnd0 + "," + opnd1 + ")";
        }
    ...
    public static class Exp_asterisco_unario extends Exp {
        ...
        public Exp_asterisco_unario(Exp exp) {
            this.exp = exp;
        }

        public String toString() {
            return "exp_asterisco_unario(" + exp + ")";
        }

        @Override public int prioridad() { return 7; }
        @Override public String imprime() { return "*$f:" + leeFila() + ",c:" + leeCol() + "$\n" + imprimeOpnd(exp, 7, true); }
    }
    ...
    public static class Exp_array extends Exp {
        ...
        public Exp_array(Exp exp, Exp idx) {
            this.exp = exp;
            this.idx = idx;
        }

        public String toString() {
            return "exp_array(" + exp + "," + idx + ")";
        }

        @Override public int prioridad() { return 6; }
        @Override public String imprime() { return imprimeOpnd(exp, 6, false) + "[$f:" + leeFila() + ",c:" + leeCol() + "$\n" + idx.imprime() + "]\n"; }
    }
    ...
    public static class Exp_campo extends Exp {
        ...
        public Exp_campo(Exp base, String id) {
            this.base = base;
            this.id = id;
        }

        public String toString() {
            return "exp_campo(" + base + "," + id + ")";
        }
    ...
    public static class Exp_flecha extends Exp {
        ...
        public Exp_flecha(Exp base, String id) {
            this.base = base;
            this.id = id;
        }

        public String toString() {
            return "exp_flecha(" + base + "," + id + ")";
        }
    ...
    public static class Lit_int extends Exp {
        ...
        public Lit_int(String num) {
            this.num = num;
        }

        public String toString() {
            return "lit_int(" + num + "[" + leeFila() + "," + leeCol() + "])";
        }
    ...
    public static class Lit_bool extends Exp {
        ...
        public Lit_bool(String valor) {
            this.valor = valor;
        }

        public String toString() {
            return "lit_bool(" + valor + "[" + leeFila() + "," + leeCol() + "])";
        }
        ...
        @Override
        public String imprime() {
            return "<" + valor + ">$f:" + leeFila() + ",c:" + leeCol() + "$\n";
        }
    }
    ...
    public static class Lit_string extends Exp {
        ...
        public Lit_string(String valor) {
            this.valor = valor;
        }

        public String toString() {
            return "lit_string(" + valor + "[" + leeFila() + "," + leeCol() + "])";
        }
    ...
    // CONSTRUCTORAS
    public Prog prog(LDec_0 decs, Instrs_0 instrs) {
        return new Prog(decs, instrs);
    }

    public LDec_0 si_dec(LDec decs) {
        return new Si_dec(decs);
    }

    public LDec_0 no_dec() {
        return new No_dec();
    }

    public LDec muchas_decs(LDec decs, Dec dec) {
        return new Muchas_decs(decs, dec);
    }

    public LDec una_dec(Dec dec) {
        return new Una_dec(dec);
    }

    public Dec dec_var(String id, Tipo tipo) {
        return new Dec_var(id, tipo);
    }

    public Dec dec_tipo(String id, Tipo tipo) {
        return new Dec_tipo(id, tipo);
    }
    ...
    public Tipo tipo_id(String id) {
        return new Tipo_id(id);
    }

    public Tipo tipo_array(String tam, Tipo tipo) {
    ...
    public Tipo tipo_record(ListaRecord lr) {
        return new Tipo_record(lr);
    }

    public ListaRecord muchos_camposrecord(ListaRecord l, CamposRecord c) {
        return new Muchos_camposrecord(l, c);
    }

    public ListaRecord un_camporecord(CamposRecord c) {
        return new Un_camporecord(c);
    }

    public CamposRecord camporecord(String id, Tipo tipo) {
        return new CamposRecord(id, tipo);
    }

    public LProcParams_0 si_procparam(LProcParams p) {
        return new Si_procparam(p);
    }

    public LProcParams_0 no_procparam() {
        return new No_procparam();
    }

    public LProcParams muchos_procparam(LProcParams l, Param p) {
        return new Muchos_procparam(l, p);
    }

    public LProcParams un_procparam(Param p) {
        return new Un_procparam(p);
    }

    public Param param_ref(String id, Tipo t) {
        return new Param_ref(id, t);
    }

    public Param param_val(String id, Tipo t) {
        return new Param_val(id, t);
    }

    public Instrs_0 si_instr(LInstr l) {
        return new Si_instr(l);
    }

    public Instrs_0 no_instr() {
        return new No_instr();
    }

    public LInstr_0 si_instr0(LInstr l) {
        return new Si_instr0(l);
    }

    public LInstr_0 no_instr0() {
        return new No_instr0();
    }

    public LInstr muchas_instr(LInstr l, Instr i) {
        return new Muchas_instr(l, i);
    }

    public LInstr una_instr(Instr i) {
        return new Una_instr(i);
    }

    public Instr instr_asig(Exp e1, Exp e2) {
        return new Instr_asig(e1, e2);
    }

    public Instr instr_if(Exp e, LInstr_0 l) {
        return new Instr_if(e, l);
    }

    public Instr instr_ifelse(Exp e, LInstr_0 l1, LInstr_0 l2) {
        return new Instr_ifelse(e, l1, l2);
    }

    public Instr instr_while(Exp e, LInstr_0 l) {
        return new Instr_while(e, l);
    }

    public Instr instr_lectura(Exp e) {
        return new Instr_lectura(e);
    }

    public Instr instr_escritura(Exp e) {
        return new Instr_escritura(e);
    }

    public Instr instr_reserva(Exp e) {
        return new Instr_reserva(e);
    }

    public Instr instr_liberacion(Exp e) {
        return new Instr_liberacion(e);
    }

    public Instr instr_invocar(String id, LExps_0 p) {
        return new Instr_invocar(id, p);
    }

    public Instr instr_compuesta(LDec_0 d, Instrs_0 i) {
        return new Instr_compuesta(d, i);
    }

    public LExps_0 si_exps(LExps p) {
        return new Si_exps(p);
    }

    public LExps_0 no_exps() {
        return new No_exps();
    }

    public LExps muchas_exps(LExps l, Exp e) {
        return new Muchas_exps(l, e);
    }

    public LExps una_exp(Exp e) {
        return new Una_exp(e);
    }

    public Exp exp_suma(Exp e1, Exp e2) {
        return new Exp_suma(e1, e2);
    }

    public Exp exp_resta(Exp e1, Exp e2) {
        return new Exp_resta(e1, e2);
    }

    public Exp exp_mul(Exp e1, Exp e2) {
        return new Exp_mul(e1, e2);
    }

    public Exp exp_div(Exp e1, Exp e2) {
        return new Exp_div(e1, e2);
    }

    public Exp exp_mod(Exp e1, Exp e2) {
        return new Exp_mod(e1, e2);
    }

    public Exp exp_and(Exp e1, Exp e2) {
        return new Exp_and(e1, e2);
    }

    public Exp exp_or(Exp e1, Exp e2) {
        return new Exp_or(e1, e2);
    }

    public Exp exp_menor(Exp e1, Exp e2) {
        return new Exp_menor(e1, e2);
    }

    public Exp exp_mayor(Exp e1, Exp e2) {
        return new Exp_mayor(e1, e2);
    }

    public Exp exp_menor_igual(Exp e1, Exp e2) {
        return new Exp_menor_igual(e1, e2);
    }

    public Exp exp_mayor_igual(Exp e1, Exp e2) {
        return new Exp_mayor_igual(e1, e2);
    }

    public Exp exp_igual(Exp e1, Exp e2) {
        return new Exp_igual(e1, e2);
    }

    public Exp exp_distinto(Exp e1, Exp e2) {
        return new Exp_distinto(e1, e2);
    }

    public Exp exp_menos_unario(Exp e) {
        return new Exp_menos_unario(e);
    }

    public Exp exp_not(Exp e) {
        return new Exp_not(e);
    }

    public Exp exp_asterisco_unario(Exp e) {
        return new Exp_asterisco_unario(e);
    }

    public Exp exp_array(Exp e, Exp i) {
        return new Exp_array(e, i);
    }

    public Exp exp_campo(Exp e, String id) {
        return new Exp_campo(e, id);
    }

    public Exp exp_flecha(Exp e, String id) {
        return new Exp_flecha(e, id);
    }
    ...
    public Lit_int lit_int(String n) {
        return new Lit_int(n);
    }

    public Lit_real lit_real(String n) {
        return new Lit_real(n);
    }

    public Lit_bool lit_bool(String b) {
        return new Lit_bool(b);
    }

    public Lit_string lit_string(String s) {
        return new Lit_string(s);
    }

    public Lit_null lit_null() {
        return new Lit_null();
    }
}