...
public class SintaxisAbstractaTiny {
    ...
    public static class Prog extends Nodo {
        ...
        public String imprime() {
            return "<program>\n" + (decs != null ? decs.imprime() : "") + (instrs != null ? instrs.imprime() : "")
                    + "<end_program>\n";
        }
    ...
    public static class Instr_if extends Instr {
        ...
        public Instr_if(Exp exp, Instrs_0 instrs) {
            this.exp = exp;
            this.instrs = instrs;
        }
    ...
    public static class Instr_ifelse extends Instr {
        ...
        public Instr_ifelse(Exp exp, Instrs_0 instrs1, Instrs_0 instrs2) {
            this.exp = exp;
    ...
    public static class Instr_while extends Instr {
        ...
        public Instr_while(Exp exp, Instrs_0 instrs) {
            this.exp = exp;
            this.instrs = instrs;
        }
    ...
    public static abstract class Exp extends Nodo {
        ...
        public boolean es_asociativa_izquierda() {
            int p = prioridad();
            return p == 1 || p == 3 || p == 6;
        }

        public boolean es_asociativa_derecha() {
            int p = prioridad();
            return p == 5 || p == 7;
        }
    ...
    public static class Exp_suma extends ExpBin {
        public Exp_suma(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_resta extends ExpBin {
        public Exp_resta(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_mul extends ExpBin {
        public Exp_mul(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_div extends ExpBin {
        public Exp_div(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_mod extends ExpBin {
        public Exp_mod(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_and extends ExpBin {
        public Exp_and(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_or extends ExpBin {
        public Exp_or(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_menor extends ExpBin {
        public Exp_menor(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_mayor extends ExpBin {
        public Exp_mayor(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_menor_igual extends ExpBin {
        public Exp_menor_igual(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_mayor_igual extends ExpBin {
        public Exp_mayor_igual(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_igual extends ExpBin {
        public Exp_igual(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_distinto extends ExpBin {
        public Exp_distinto(Exp o0, Exp o1, int f, int c) {
            super(o0, o1, f, c);
        }
    ...
    public static class Exp_menos_unario extends ExpUni {
        public Exp_menos_unario(Exp o, int f, int c) {
            super(o, f, c);
        }
    ...
    public static class Exp_not extends ExpUni {
        public Exp_not(Exp o, int f, int c) {
            super(o, f, c);
        }
    ...
    public static class Exp_asterisco_unario extends ExpUni {
        public Exp_asterisco_unario(Exp o, int f, int c) {
            super(o, f, c);
        }
    ...
    public static class Iden extends Exp {
        ...
        public Iden(String id, int f, int c) {
            this.id = id;
            this.ponFila(f);
            this.ponCol(c);
        }
    ...
    public static class Lit_int extends Exp {
        ...
        public Lit_int(String val, int f, int c) {
            this.val = val;
            this.ponFila(f);
            this.ponCol(c);
        }
    ...
    public static class Lit_real extends Exp {
        ...
        public Lit_real(String val, int f, int c) {
            this.val = val;
            this.ponFila(f);
            this.ponCol(c);
        }
    ...
    public static class Lit_bool extends Exp {
        ...
        public Lit_bool(String val, int f, int c) {
            this.val = val;
            this.ponFila(f);
            this.ponCol(c);
        }
    ...
    public static class Lit_string extends Exp {
        ...
        public Lit_string(String val, int f, int c) {
            this.val = val;
            this.ponFila(f);
            this.ponCol(c);
        }
    ...
    public static class Exp_campo extends Exp {
        ...
        public Exp_campo(Exp b, String i, int f, int c) {
            this.base = b;
            this.id = i;
            this.ponFila(f);
            this.ponCol(c);
    ...
    public static class Exp_flecha extends Exp {
        ...
        public Exp_flecha(Exp b, String i, int f, int c) {
            this.base = b;
            this.id = i;
            this.ponFila(f);
            this.ponCol(c);
    ...
    public static class Exp_array extends Exp {
        ...
        public Exp_array(Exp o0, Exp o1, int f, int c) {
            this.opnd0 = o0;
            this.opnd1 = o1;
            this.ponFila(f);
            this.ponCol(c);
        ...
        @Override
        public String imprime() {
            return imprimeOpnd(opnd0, 6, false) + "[$f:" + leeFila() + ",c:" + leeCol() + "$\n" + opnd1.imprime()
                    + "]\n";
        }
    ...
    public Dec dec_var(String id, Tipo tipo) {
        return new Dec_var(id, tipo, -1, -1);
    }

    public Dec dec_tipo(String id, Tipo tipo) {
        return new Dec_tipo(id, tipo, -1, -1);
    }

    public Dec dec_proc(String id, LProcParams_0 params, LDec_0 decs, Instrs_0 instrs) {
        return new Dec_proc(id, params, decs, instrs, -1, -1);
    }

    public LProcParams_0 si_procparam(LProcParams params) {
        return new Si_procparam(params);
    }
    ...
    public LProcParams muchos_procparam(LProcParams params, Param param) {
        return new Muchos_procparam(params, param);
    }

    public LProcParams un_procparam(Param param) {
        return new Un_procparam(param);
    }

    public Param param_ref(String id, Tipo tipo) {
        return new Param_ref(id, tipo, -1, -1);
    }

    public Param param_val(String id, Tipo tipo) {
        return new Param_val(id, tipo, -1, -1);
    }
    ...
    public Tipo tipo_id(String id) {
        return new Tipo_id(id, -1, -1);
    }

    public Tipo tipo_array(String dim, Tipo tipo) {
        return new Tipo_array(dim, tipo, -1, -1);
    }
    ...
    public Tipo tipo_record(ListaRecord lista) {
        return new Tipo_record(lista);
    }

    public ListaRecord muchos_camposrecord(ListaRecord lista, CamposRecord campo) {
        return new Muchos_camposrecord(lista, campo);
    }

    public ListaRecord un_camporecord(CamposRecord campo) {
        return new Un_camporecord(campo);
    }

    public CamposRecord camporecord(String id, Tipo tipo) {
        return new CamposRecord(id, tipo, -1, -1);
    }

    public Instrs_0 si_instr(LInstr instrs) {
        return new Si_instr(instrs);
    }
    ...
    public Instrs_0 si_instr0(LInstr instrs) {
        return new Si_instr(instrs);
    }

    public Instrs_0 no_instr0() {
        return new No_instr();
    }

    public LInstr muchas_instr(LInstr instrs, Instr instr) {
        return new Muchas_instr(instrs, instr);
    }

    public LInstr una_instr(Instr instr) {
    ...
    public Instr instr_if(Exp e, Instrs_0 i) {
        return new Instr_if(e, i);
    }

    public Instr instr_ifelse(Exp e, Instrs_0 i1, Instrs_0 i2) {
        return new Instr_ifelse(e, i1, i2);
    }

    public Instr instr_while(Exp e, Instrs_0 i) {
        return new Instr_while(e, i);
    }
    ...
    public Instr instr_invocar(String id, LExps_0 exps) {
        return new Instr_invocar(id, exps, -1, -1);
    }
    ...
    public LExps_0 si_exps(LExps exps) {
    ...
    public LExps muchas_exps(LExps exps, Exp exp) {
        return new Muchas_exps(exps, exp);
    }

    public LExps una_exp(Exp exp) {
        return new Una_exp(exp);
    }

    public Exp exp_suma(Exp e1, Exp e2) {
        return new Exp_suma(e1, e2, -1, -1);
    }

    public Exp exp_resta(Exp e1, Exp e2) {
        return new Exp_resta(e1, e2, -1, -1);
    }

    public Exp exp_mul(Exp e1, Exp e2) {
        return new Exp_mul(e1, e2, -1, -1);
    }

    public Exp exp_div(Exp e1, Exp e2) {
        return new Exp_div(e1, e2, -1, -1);
    }

    public Exp exp_mod(Exp e1, Exp e2) {
        return new Exp_mod(e1, e2, -1, -1);
    }

    public Exp exp_and(Exp e1, Exp e2) {
        return new Exp_and(e1, e2, -1, -1);
    }

    public Exp exp_or(Exp e1, Exp e2) {
        return new Exp_or(e1, e2, -1, -1);
    }

    public Exp exp_menor(Exp e1, Exp e2) {
        return new Exp_menor(e1, e2, -1, -1);
    }

    public Exp exp_mayor(Exp e1, Exp e2) {
        return new Exp_mayor(e1, e2, -1, -1);
    }

    public Exp exp_menor_igual(Exp e1, Exp e2) {
        return new Exp_menor_igual(e1, e2, -1, -1);
    }

    public Exp exp_mayor_igual(Exp e1, Exp e2) {
        return new Exp_mayor_igual(e1, e2, -1, -1);
    }

    public Exp exp_igual(Exp e1, Exp e2) {
        return new Exp_igual(e1, e2, -1, -1);
    }

    public Exp exp_distinto(Exp e1, Exp e2) {
        return new Exp_distinto(e1, e2, -1, -1);
    }

    public Exp exp_menos_unario(Exp e) {
        return new Exp_menos_unario(e, -1, -1);
    }

    public Exp exp_not(Exp e) {
        return new Exp_not(e, -1, -1);
    }

    public Exp exp_asterisco_unario(Exp e) {
        return new Exp_asterisco_unario(e, -1, -1);
    }

    public Exp exp_array(Exp e, Exp i) {
        return new Exp_array(e, i, -1, -1);
    }

    public Exp exp_campo(Exp e, String id) {
        return new Exp_campo(e, id, -1, -1);
    }

    public Exp exp_flecha(Exp e, String id) {
        return new Exp_flecha(e, id, -1, -1);
    }

    public Exp iden(String id) {
        return new Iden(id, -1, -1);
    }

    public Exp lit_int(String v) {
        return new Lit_int(v, -1, -1);
    }

    public Exp lit_real(String v) {
        return new Lit_real(v, -1, -1);
    }

    public Exp lit_bool(String v) {
        return new Lit_bool(v, -1, -1);
    }

    public Exp lit_string(String v) {
        return new Lit_string(v, -1, -1);
    }

    public Exp lit_null() {
        return new Exp_null(-1, -1);
    }
}